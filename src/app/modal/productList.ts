import { ProductType, ProductModel } from '../modal/Product';

export var PRODS:ProductType[]=
[
    {
      Type:"CCTV",
      Products:[
          //CCTV CAMERAS
        {
            ...
            description:"Indoor Security Camera - This AHD dome Camera is compatible with XVR analog DVRs. <br> A base lock is designed to protect the camera from being stolen. <br> 1080P 2.4 Megapixel high definition: 1920(H) x 1080(V) , which ensures clear and sharp images for both indoor and outdoor applications. Along with 3.6mm fixed lens, it can be used widely at the driveway, front door, hallways, garage, backyard and office. Never miss a single detail of your baby, visitors and staffs, etc. <br>Great Night Vision Performance - Built-in 4 pcs Matrix EXIR Leds with IR Cut, auto switch Day/Night mode, IR range 60 feet. It uses the latest black film technology with Matrix EXIR LEDs which gives you better night vision experience, less flying insects, less power consumption and longer lifetime. No flare light in the dark. Hide your camera from being found and let you see more details at night.<br>If you want to remote view the camera on your smart phone, please connect this camera to your XVR or DVR, and then remote view on your Smart Phone through XVR/DVR. IP66 Weatherproof - This weatherproof camera can be used for both indoor and outdoor applications, with a supported temperature range from -20℃ to 55℃, 10% ~ 90% humidity. It keeps a durable and stable operation even in bad weather condition.",
            series:"lepus",
            specification:[
              {
        ...
        },
        {
            ...
            img:["assets/images/CCTV1.png"],
            description:"Indoor Security Camera - This AHD 360 Degree Panoramic Camera is compatible with HDx, AHD, HDCVI, CVBS AND HDTVI DVRs/XVRs.<br>360 Degree Panoramic Super Wide Angle View with fisheye lens, leaving No Blind Spot in the room.<br>1080P 2.4 Megapixel high definition: 1920(H) x 1080(V) , which ensures clear and sharp images for indoor applications. Along with 1.7mm broad lens. Never miss a single detail of your baby, visitors and staffs, etc. <br>Built in RS485 cable, DC power interface, BNC interface and DIP switcher make the camera plug and play feature.<br>Great Night Vision Performance - Built-in 3 pcs LED Array with HD IR-CUT Double Filter, Restoring Clear True Color.Auto switch Day/Night mode. It uses the latest black film technologywhich gives you better night vision experience, less flying insects, less power consumption and longer lifetime. No flare light in the dark. Hide your camera from being found and let you see more details at night.<br>If you want to remote view the camera on your smart phone, please connect this camera to your XVR or DVR, and then remote view on your Smart Phone through XVR/DVR. <br>IP66 Weatherproof - This weatherproof camera can be used for both indoor and outdoor applications, with a supported temperature range from -20℃to 55℃, 10% ~ 90% humidity. It keeps a durable and stable operation even in bad weather condition.",
            series:"LEPUS",
            specification:[
              {
                spec:"details of spec"
